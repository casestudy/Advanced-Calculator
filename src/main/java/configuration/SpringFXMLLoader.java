...
public class SpringFXMLLoader<S,T> {
    ...
    private SpringFXMLLoader(ApplicationContext applicationContext, URL location, InputStream inputStream, ResourceBundle resources, Charset charset) {
    ...
    public T getController() {
        if (! loaded) {
            throw new IllegalStateException("BasicCalculatorController is only available after loading");
        }
        return controller ;
    }
    ...
    public static class Builder {
        ...
        public <S,T> SpringFXMLLoader<S,T> build() {
            ...
            return new SpringFXMLLoader<S, T>(applicationContext,
                    location, inputStream, resources, charset);
        }
